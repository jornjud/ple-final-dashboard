        ...
        <header className="flex flex-col md:flex-row items-center justify-between mb-12 gap-8">
          ...
          >
            <div className="relative">
              <div className="w-32 h-32 rounded-full border-4 border-orange-400 overflow-hidden shadow-[0_0_20px_rgba(255,107,53,0.5)]">
                <img 
            ...
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-white to-orange-300 bg-clip-text text-transparent">
                Ple Dashboard
              </h1>
              <p className="text-orange-400 font-medium">Executive Secretary Assistant</p>
            </div>
          </motion.div>
          ...
          <GlassCard className="flex items-center gap-4 py-4 px-8">
            <div className="text-right">
              ...
              <p className="text-3xl font-mono font-bold text-orange-500">฿{data.usage.total_cost_thb.toFixed(2)}</p>
            </div>
            ...
            >
              <GlassCard className="hover:bg-white/15 transition-all cursor-pointer group">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-xl font-bold text-white group-hover:text-orange-300 transition-colors">{item.model}</h3>
                  <Zap className="text-orange-400 w-5 h-5" />
                </div>
                <div className="space-y-3">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Input / 1K Tokens</span>
                    <span className="font-mono text-orange-200">฿{item.input_1k_thb.toFixed(4)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Output / 1K Tokens</span>
                    <span className="font-mono text-orange-200">฿{item.output_1k_thb.toFixed(4)}</span>
                  </div>
                </div>
              </GlassCard>
            </motion.div>
        ...
        <GlassCard>
          ...
          <div className="w-full bg-white/5 rounded-full h-4 mb-4 overflow-hidden border border-white/10">
            <motion.div 
              ...
              className="bg-gradient-to-r from-orange-500 to-orange-700 h-full shadow-[0_0_10px_rgba(255,107,53,0.5)]"
            />
          </div>
